        ...
        <div class ="container-fluid Promosec2" style ={{backgroundColor:"#FCF4CF",paddingBottom:"60px"}}>
            <div class ="row">
                ...
                <div class ="col-md-5 col-sm-12">
                    <h2 style ={{fontWeight:"400"}}><b>Take the next step</b> toward<br/> your personal and professional<br/> goals with eSchool.</h2>
                    <p style={{fontSize:"20px"}}>Join now to receive personalized recommendations from the full  catalog.</p>
