...
function Nav() {
    return (
        ...
        <div class ="container-fluid pc-nav">
         <Link to="/"><span href="#"> eSchool</span></Link>

          <Link to="/resources"><span id="explorebtn">Explore&nbsp;&nbsp;<i class ="fa fa-chevron-down"></i></span></Link>
          <form id="search-form">
          ...
          <Link to="/resources"><span style={{float:"right",color:"#000"}}>Resources</span></Link>
        </div>
    </div>
    )
}
